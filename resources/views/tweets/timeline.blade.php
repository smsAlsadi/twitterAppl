    ...
    <div class="row">
        ...
        <div class="col-md-4">
          <div class="list-group">
              ...
              <button class="btn btn-primary mt-2 " data-toggle="modal" data-target="#tweetModel">{{ __('Tweet') }}</button>
            ...
            @foreach ($tweets as $tweet )
              ...
              <div class="media">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <a  href="http://localhost:8080/twiter/public/creattimeline/{{$tweet->id}}"><i class="far fa-trash-alt"></i></a>
                    </div>
                  </div>
                  {{-- #icons --}}
                  </div>
